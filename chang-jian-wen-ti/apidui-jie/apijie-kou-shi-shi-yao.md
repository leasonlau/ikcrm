...
首先联系客服400-867-1101（如果已经购买可联系售后客服），申请对接，客服将对你的企业开放帐号密码设置功能。然后进入爱客CRM的设置中心—部门和用户，点击姓名旁边的编辑按钮，设置手机号，再点击姓名旁边的修改密码按钮，设置密码。![](/assets/API接口怎么用1.png)![](/assets/API接口怎么用2.png)
