...
#### 严格的服务器访问权限控制
 ...
 尽一切可能，降低人的缺陷导致数据被滥用的可能性。我们的所有收入都来自客户的付费，我们相信，只要我们的软件服务好，能让客户心甘情愿的持续付费，就足以支持我们成功。我们对服务器的管理严格执行SOD，不同的人掌握不同权限的帐号，避免一个人完成所有的操作，最大限度降低数据的破坏风险性。 不能丢，不被偷，不做恶，是我们对所有爱客CRM客户的承诺。
