...
如果要对单个客户进行管理，或者查看客户的详细信息以及历史的跟进记录等，可点击客户名称进入客户详情。![](/assets/客户详情01.png)![](/assets/客户详情03.png)在客户详情页，可以对客户进行编辑、转移、删除、添加联系人/商机/合同等操作，还可以查看客户相关的所有信息如客户的资料、销售动态、联系人、商机、合同、费用、任务、附件、操作日志等。
